...
3. mkdir test_data
4. mv test* test_data/
5. mkdir scripts_shell
6. mv *.sh scripts_shell/
7. mkdir scripts_R
8. mv *.R scripts_R/
9. mkdir hpc_start
10. mv *.qsub hpc_start/
...
The default "start" time is the Unix epoch. This is 00:00:00 UTC on 1 January 1970. For my machine, it shows December 31, 1969 at 19:00:00 because I am located in GMT-05:00 
...
```{r}
as.numeric(x[grepl("\\d", x)])[as.numeric(x[grepl("\\d", x)]) %% 3 == 0]
```
